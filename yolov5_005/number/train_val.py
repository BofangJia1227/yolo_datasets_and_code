...
for image_set in sets:
    if not os.path.exists('../num/all_labels/'):
        os.makedirs('../num/all_labels/')
...
#按照划分好的训练文件的路径搜索目标，并将其复制到yolo格式下的新路径
copy_file('../num/images/train/', './images_train.txt', './all_images')
copy_file('../num/images/val/', './images_trainval.txt', './all_images')
copy_file('../num/labels/train/', './labels_train.txt', './all_labels')
copy_file('../num/labels/val/', './labels_trainval.txt', './all_labels')
